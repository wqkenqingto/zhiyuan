      ...
      <div class="width1003">
       <div class="content-left">
        ...
        <ul class="leftNav">
         ...
         <li class="leftNavCur"><a href="network.jsp">网点查询</a></li>
       ...
       <div class="content-right">
        ...
        <form action="#" method="get" class="searchs">
         <div class="inputexts"><input type="text" placeholder="请输入城市名称" /></div>
         <div class="inputexts"><input type="text" placeholder="请输入街道地址" /></div>
