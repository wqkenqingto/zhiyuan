  ...
  <body> -->
     ...
     <div class="nav">
      <ul class="width1003">
       ...
       <li><a href="http://localhost:8080/zy/news/newsAction_loadAllNews.action">新闻公告</a></a></a>
        <div class="chilNav">
     ...
     <div class="content">
      <div class="width1003">
       <div class="content-left">
        ...
        <ul class="leftNav">
         <li><a href="service.jsp">物流常识</a></li>
         <li><a href="service.jsp">新手入门</a></li>
         <li class="leftNavCur"><a href="tousu.jsp">投诉建议</a></li>
       ...
       <div class="content-right">     
        <form action="complaint/complaintAction_saveComplaint.action" method="post" class="tousu">
        	<h2 class="right-title">投诉主题</h2>
        	<input type="text" class="toutext"  name="complaint.theme" />
         <label>您的姓名：</label>
         <input type="text" class="toutext" name="complaint.cname" />
         <label>你的订单</label>
         <input type="text" class="toutext" name="order.onumber" />
         <label>你的联系方式</label>
         <input type="text" class="toutext" name="complaint.contact" />
         <label>您的建议：</label>
         <textarea name="complaint.content"></textarea>
         <div class="tousub"><input type="submit" value="立即提交" /></div>
        </form><!--tousu/-->
       </div><!--content-right/-->
       <div class="clearfix"></div>
      </div><!--width1003/-->
     ...
     <footer>
      <div class="width1003">
       ...
       <ul>
        <li class="ft-title"><a href="http://localhost:8080/zy/news/newsAction_loadAllNews.action"><a href="http://localhost:8080/zy/news/newsAction_loadAllNews.action">新闻公告</a></a></li>
     ...
     <div class="copy">
		Copyright © wqkenqing    京ICP备16021314号-1    北京市海淀区金燕龙大厦304号 技术支持：秋意网
     </div>
