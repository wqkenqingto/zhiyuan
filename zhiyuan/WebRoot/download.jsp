     ...
     <div class="nav">
      <ul class="width1003">
       ...
       <li><a href="http://localhost:8080/zy/news/newsAction_loadAllNews.action">新闻公告</a>
        <div class="chilNav">
         <a href="http://localhost:8080/zy/news/newsAction_loadAllNews.action">新闻公告</a>
         <a href="news.jsp">志远公告</a>
         <a href="news.jsp">行业动态</a>
         <a href="news.jsp">企业视频</a>
         <a href="news.jsp">企业微博</a>
        </div>
       </li>
      ...
      <div class="width1003">
       <div class="content-left">
        ...
        <ul class="leftNav">
         ...
         <li class="leftNavCur"><a href="download.jsp">下载中心</a></li>
        </ul>
        <div class="lefticon">
       ...
       <div class="content-right">
        <h2 class="right-title">下载中心</h2>
        <ul class="new">
         <li><a href="javascript:;">习近平主持政治局会议 研究2016年经济工作</a> <a href="#" class="downs">下载</a></li>
         <li><a href="javascript:;">李克强为上合总理会领导人举行欢迎晚宴  专题</a> <a href="#" class="downs">下载</a></li>
         <li><a href="javascript:;">互联网公司造生态品质难保 用高估值“补血”</a> <a href="#" class="downs">下载</a></li>
         <li><a href="javascript:;">钢铁大佬戴国芳出狱东山再起 投10亿美厂</a> <a href="#" class="downs">下载</a></li>
         <li><a href="javascript:;">军报报道披露：随着军队改革展开 干部调整暂停</a> <a href="#" class="downs">下载</a></li>
         <li><a href="javascript:;">官员争取到“贫困县”到处炫耀 网站发特大喜讯</a> <a href="#" class="downs">下载</a></li>
