...
<html>
  ...
  <body>
      ...
      <div class="width1003">
       ...
       <div class="content-right">
        ...
        <form action="order/orderAction_getOrderInfo.action" method="get" class="searchs">
         <div class="yam">  <input type="text"placeholder="输入关键字搜索"  aria-describedby="basic-addon2" name="order.wayNum" style="width:200px;heigt:20px"></div>
	...
	<tr>	
	<td>${o.sender.sname}</td>
		<td>${o.reciever.rname}</td>
		<td>${o.date}</td>
		<td>${o.state}</td>
		<td><a href="tousu.jsp"><strong>投诉</strong></a>&nbsp<a href="#"><strong>更多</strong></a></td>
	</s:iterator>	
</table>
        </div>
       </div><!--content-right/-->
