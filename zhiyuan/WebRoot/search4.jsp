...
<!--          <a href="search3.jsp">货物追踪</a>
 -->         <a href="search4.jsp">订单查询</a>
      ...
      <div class="width1003">
       <div class="content-left">
        ...
        <!--  <li><a href="search3.jsp">货物追踪</a></li> -->
         <li class="leftNavCur"><a href="search4.jsp">订单查询</a></li>
        </ul>
        <div class="lefticon">
       ...
       <div class="content-right">
        <h2 class="right-title">订单查询</h2>
      <form action="order/orderAction_getOrderInfo.action" method="get" class="searchs">
         <div class="yam">  <input type="text"placeholder="输入关键字搜索"  aria-describedby="basic-addon2" name="order.onumber" style="width:200px;heigt:20px"></div>
	...
	<td>${order.sender.sname}</td>
		<td>${order.reciever.rname}</td>
		<td>${order.date}</td>
		<td>${order.state}</td>
		<td><a href="tousu.jsp"><strong>投诉</strong></a> <!-- <a href="#"><strong>更多</strong></a> --> </td>
</table>
        </div>
       </div><!--content-right/-->
       <div class="clearfix"></div>
