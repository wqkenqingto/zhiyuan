     ...
     <div class="content">
      <div class="width1003">
       ...
       <div class="content-right">
        <h2 class="right-title">网点查询(暂时只开通北京)</h2>
        <div class="netlist">
         <dl>
          <dt><strong>北京</strong> 7个网点    </dt>
          <dd>
          	<s:iterator value="#request.netlist" var="net">
           <a href="http://localhost:8080/zy/network/netWorkAction_loadNetWorkByNid.action?netWork.nid=${net.nid}">${net.nname}</a>
           </s:iterator>
          </dd>
         </dl>
        </div><!--netlist/-->
