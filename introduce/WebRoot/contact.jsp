...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Relic &mdash; A free Responsive HTML5 Template </title>
	...
	<body class="gototop">
		...
		<header id="fh5co-header" role="banner">
			...
			<div id="fh5co-logo" class="text-center"><a href="index.jsp"><img src="images/logo.png" alt="Image"></a></div>
		</header>
		<!-- Header -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-3">
						...
						<p>A Free HTML5 templates created by More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a> &amp; Images by <a href="#" target="_blank">Unsplash.com</a></p>
					</div>
					<div class="col-md-5">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="fh5co-copyright">
							<p class="pull-left">&copy;	Relic 2015. All Rights Reserved. <br> Lovely crafted by More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a> Images by <a href="#">Unsplash</a> </p> 
